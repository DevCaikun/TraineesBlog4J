/*
 ...
 Source Server         : TraineesBlog
 Source Server Type    : MySQL
 Source Server Version : 50736
 Source Host           : localhost:3306
 Source Schema         : TraineesBlog
...
-- TraineesBlog 所需的初始化数据，如登录用户、用户角色、博客设置信息
INSERT INTO `ibp`.`t_user` (`id`, `username`, `password`, `create_time`, `update_time`, `is_deleted`) VALUES (1, 'admin', '$2a$10$hxxHGc2Bqz9KD4S24.N59O37kaaGRFEuP5WknZENdIsnLr9R1EiOq', '2023-07-03 11:57:18', '2023-09-24 16:23:29', 0);
INSERT INTO `ibp`.`t_user` (`id`, `username`, `password`, `create_time`, `update_time`, `is_deleted`) VALUES (2, 'test', '$2a$10$L6ce4rQsyJ1k7ZCOfN6X4e5dHLyvg2X0t9JFEZBezDq0lds79Pxja', '2023-07-07 01:22:05', '2023-07-07 01:22:05', 0);
INSERT INTO `ibp`.`t_user_role` (`id`, `username`, `role`, `create_time`) VALUES (1, 'admin', 'ROLE_ADMIN', '2023-07-07 01:21:15');
INSERT INTO `ibp`.`t_user_role` (`id`, `username`, `role`, `create_time`) VALUES (2, 'test', 'ROLE_VISITOR', '2023-07-07 01:23:33');
INSERT INTO `ibp`.`t_blog_settings` (`id`, `logo`, `name`, `author`, `introduction`, `avatar`, `github_homepage`, `csdn_homepage`, `gitee_homepage`, `zhihu_homepage`) VALUES (1, 'https://img.trainees.cn/ibp/f97361c0429d4bb1bc276ab835843065.jpg', '程序员菜鲲的博客', '程序员菜鲲', '平安喜乐test', 'https://img.trainees.cn/ibp/f97361c0429d4bb1bc276ab835843065.jpg', 'https://www.trainees.cn', 'https://www.trainees.cn', 'https://www.trainees.cn', 'https://www.trainees.cn');
