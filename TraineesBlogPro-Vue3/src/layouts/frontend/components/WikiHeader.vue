        ...
        <nav class="bg-white border-gray-200 border-b dark:bg-[#0d1117] dark:border-gray-800">
            <div class="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="flex items-center">
                    ...
                    <!-- 博客 LOGO 、博客名称 -->
                    <a href="/" class="flex items-center bg-[#111827] mr-3 ml-3 rounded-[0.5rem]">
                        <img :src="blogSettingsStore.blogSettings.logo" class="h-12 mr-3 ml-3 rounded-full" alt="TraineesBlog Logo" />
                        <span v-if="false" class="self-center text-2xl font-semibold whitespace-nowrap dark:text-gray-400">{{
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
                    ...
                    <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 
                        ...
                        <li>
                          <a @click="router.push('/navigation')"
                             :class="[currPath == '/navigation' ? 'text-sky-600 md:border-b-2 md:border-sky-600 dark:text-sky-500 dark:md:border-sky-600' : 'text-gray-900 dark:text-white']"
                             class="block py-2 pl-3 pr-4 rounded md:rounded-none hover:bg-gray-100 md:hover:bg-transparent md:hover:text-sky-600
                                  md:p-0 md:dark:hover:text-sky-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent
                                  dark:border-gray-700">资源导航</a>
                        </li>
                        <li>
                          <a @click="router.push('/toolkit')"
                             :class="[currPath == '/toolkit' ? 'text-sky-600 md:border-b-2 md:border-sky-600 dark:text-sky-500 dark:md:border-sky-600' : 'text-gray-900 dark:text-white']"
                             class="block py-2 pl-3 pr-4 rounded md:rounded-none hover:bg-gray-100 md:hover:bg-transparent
                                  md:hover:text-sky-600 md:p-0 md:dark:hover:text-sky-500 dark:hover:bg-gray-700
                                  dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">在线工具</a>
                        </li>
                    </ul>
                </div>
            </div>
