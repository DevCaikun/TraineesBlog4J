        ...
        <nav class="bg-white border-gray-200 border-b dark:bg-gray-900 dark:border-gray-800">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <a href="/" class="flex items-center bg-[#111827] mr-3 ml-3 rounded-[0.5rem]">
                    <img :src="blogSettingsStore.blogSettings.logo" class="h-12 rounded-full " alt="TraineesBlog Logo" />
                    <span v-if="false" class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">{{
