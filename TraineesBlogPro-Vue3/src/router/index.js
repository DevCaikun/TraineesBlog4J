...
const routes = [
    ...
    },
    {
        ...
        path: '/navigation', // 知识库详情页
        component: () => import("@/pages/frontend/navigation.vue"),
        meta: {
            title: 'TraineesBlog 编程资源导航'
        }
    },{
        path: '/toolkit', // 知识库详情页
        component: () => import("@/pages/frontend/tool-kit.vue"),
        meta: {
            title: 'TraineesBlog 在线工具箱'
        }
    },
    {
        path: '/login', // 登录页
