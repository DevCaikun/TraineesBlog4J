    ...
    <div class="grid grid-cols-2 h-screen">
        ...
        <div class="col-span-2 order-2 p-10 md:col-span-1 md:order-1 bg-slate-900">
            ...
            <div
                ...
                <h2 class="font-bold text-4xl mb-7 text-white">TraineesBlog-V1-Java-Ts 登录</h2>
              <p class="text-white">一款后端由 OpenJDK11+SpringBoot2+SpringSecurity5+MyBatisPlus3+MySql8</p>
              <p class="text-white">前端由 TypeScript5+Vite6+Vue3+ElementPlus2+Tailwindcss4 开发的前后端分离博客。</p>
                <!-- 指定图片宽度为父级元素的 1/2 -->
