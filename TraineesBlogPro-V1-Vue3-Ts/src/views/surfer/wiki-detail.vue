                            ...
                            <div class="flex gap-3 md:gap-6 text-gray-400 items-center text-sm pb-3 
                                ...
                                <div class="hidden md:block">
                                    <div class="flex items-center" data-tooltip-target="read-time-tooltip-bottom"
                                        data-tooltip-placement="bottom">
                                        <svg t="1701512553358" class="w-4 h-4 mr-1.5 icon" viewBox="0 0 1024 1024"
                                            version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="37812" width="48"
                                            height="48">
                                            <path
                                ...
                                <div class="flex items-center" data-tooltip-target="publish-time-tooltip-bottom"
                                    data-tooltip-placement="bottom">
                                    <svg t="1701513012543" class="w-[18px] h-[18px] mr-1 icon" viewBox="0 0 1024 1024"
                                        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="41600" width="48"
                                        height="48">
                                        <path
                                ...
                                <div class="flex items-center" data-tooltip-target="read-num-tooltip-bottom"
                                    data-tooltip-placement="bottom">
                                    <svg t="1701513523793" class="w-[18px] h-[18px] mr-1 icon" viewBox="0 0 1024 1024"
                                        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="56112" width="48"
                                        height="48">
                                        <path
...
import WikiHeader from '@/layouts/surfer/components/WikiHeader.vue'
import WikiFooter from '@/layouts/surfer/components/WikiFooter.vue'
import WikiToc from '@/layouts/surfer/components/WikiToc.vue'
import { getArticleDetail } from '@/api/surfer/article'
import { useDark } from '@vueuse/core'
import { getWikiArticlePreNext, getWikiCatalogs } from '@/api/surfer/wiki'
